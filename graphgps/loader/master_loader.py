...
def load_dataset_master(format, name, dataset_dir):
    ...
    if format.startswith('PyG-'):
        ...
        elif pyg_dataset_id == 'LRGBDataset':
            dataset = preformat_LRGBDataset(dataset_dir, name)
        else:
...
def preformat_LRGBDataset(dataset_dir, name):
    """Load and preformat datasets from PyG's LRGBDataset.
    ...
    Returns:
        PyG dataset object
    """
    if name in ['PascalVOC-SP', 'COCO-SP', 'Peptides-func', 'Peptides-struct', 'PCQM-Contact']:
        tf_list = []  # concat pixel value and pos. coordinate
    else:
    ...
    if name in ['PascalVOC-SP', 'COCO-SP', 'Peptides-func', 'Peptides-struct', 'PCQM-Contact']:
        dataset = join_dataset_splits(
            [LRGBDataset(root=dataset_dir, name=name, split=split)
